...
class NotebooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notebook" do
    assert_difference('Notebook.count') do
      post notebooks_url, params: { notebook: { title: @notebook.title, user_id: @notebook.user_id } }
    end
  ...
  test "should update notebook" do
    patch notebook_url(@notebook), params: { notebook: { title: @notebook.title, user_id: @notebook.user_id } }
